...
#money_left_s = t_recieved-comm1
commision = comm0+comm1             #Total money paid to broker

moneyleft = t_recieved-commision
...
print(f"The amount of money Joe has left is : $ {moneyleft}")
if(moneyleft>0):
    print(f"Joe has made a profit of :$ {moneyleft}")
else:
